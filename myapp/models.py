...
class StatusMyApp(models.Model):
...
class Order(models.Model):
    ...
    order_status = models.ForeignKey(StatusMyApp, on_delete=models.PROTECT, null=True, blank=True, verbose_name='Статус')
...
class CommentMyApp(models.Model):
